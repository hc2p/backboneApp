...
(function(/*! Stitch !*/) {
...
}).call(this)({"collections/app_data": function(exports, require, module) {
  exports.appData = {
    "global": {
      "title": "happenApp"
    },
    "pages": [
      {
        ...
        "name": "info",
        "title": "Info",
        "text": "<p>hoppla das sollte doch eingentlich html sein!</p>"
      }
    ]
  };
  ...
  $(document).ready(function() {
    app.initialize = function() {
      ...
      if (Backbone.history.getFragment() === '') {
        return Backbone.history.navigate('/page/home', true);
      }
    };
    app.initialize();
  ...
  $(document).load(function() {
    return window.applicationCache.addEventListener('updateready', function(e) {
      ...
      if (confirm('A new version of this site is available. Load it?')) {
        ...
        return log("Manifest didn't changed. Nothing new to server.");
      }
    });
  });
  ...
  (function() {
    (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        page = _ref[_i];
        __out.push('\n\t\t<li class="">\n\t\t\t<a href="#/page/');
        __out.push(__sanitize(page.attributes.name));
        __out.push('" >\n\t\t\t\t');
        __out.push(__sanitize(page.attributes.title));
        __out.push('\n\t\t\t</a>\n\t\t</li>\n\t');
      }
  ...
  return __out.join('');
}}, "templates/header": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/page": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/app_view": function(exports, require, module) {(function() {
  var footerTemplate, headerTemplate;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
